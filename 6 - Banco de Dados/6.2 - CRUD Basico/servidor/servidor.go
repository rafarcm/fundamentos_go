...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		w.Write([]byte("Erro ao inserir o usuário!"))
		return
	}
...
// BuscarUsuario traz um usuário epecífico salvo no banco de dados
...
// DeletarUsuario remove um usuário salvo no banco de dados
